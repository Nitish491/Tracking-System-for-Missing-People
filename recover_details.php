...
<body  style="background:#ecf0f1 ;">
    ...
    $con = mysqli_connect('localhost','root','','trackchild');
     ...
     $query2="select image from recovered where fir_no=$firnoo";
  ...
  <form action="#" method="post">
      ...
      <div class="row">
          ...
          <div class="col-sm-4">
          <center><button class="mt-2"><img src=" <?php echo $result2['image'];  ?>" height="100px" width="100px"></button>   <h6>recovered person image</h6></center>
