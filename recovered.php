...
<body style="background-color:#ecf0f1">
    ...
    <div class="container">
        <br>
        <h1 class="text-white bg-dark text-center">RECOVERED PEOPLE PHOTOGRAPHS
        </h1>
        <br>
        <h6>Click on Image to get Details</h6>
...
//echo "Connected successfully";
    ...
    echo "Error: " . $q. "<br>" . mysqli_error($con);
		      	...
		      	$displayquery ="select * from recovered ";
		       	...
		       	?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href='./recover_details.php?firno=<?php echo "$firno"; ?>'><button>
    ...
    <div id="modal-wrapper" class="modal">
        ...
        <form class="modal-content animate" action="/action_page.php">
           ...
           while( $result1 =mysqli_fetch_array($display) ){?>
                ...
                <div class="row " style="height:15rem">
                    <div class="col-sm-4  ">
                      ...
                      <?php 
  	            $query1 ="select * from identification_marks where fir_number=101 ";
           ...
           while( $result2 =mysqli_fetch_array($display1) ){?>
                    ...
                    <?php 
  	            $query2 ="select * from physical_features where fir_number=101 ";
