...
<body>
    ...
    <div class="container">
        <br>
        <h1 class="text-white bg-dark text-center">SIGHTED PEOPLE PHOTOGRAPHS
        </h1>
        <br>
...
echo "Connected successfully";
    ...
    echo "Error: " . $q. "<br>" . mysqli_error($con);
		      	...
		      	$displayquery ="select * from imgupload,sight where sight.fir_number=imgupload.fir_no ";
		       	...
		       	?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href='./detailcofirmation.php?firno=<?php echo "$firno"; ?>'><button>
    ...
    <div id="modal-wrapper" class="modal">
        ...
        <form class="modal-content animate" action="/action_page.php">
            ...
            <div class="container">
                ...
                $query1="select * from sight where fir_no=101";
		      	$display = mysqli_query($con,$query); 
                $display2 = mysqli_query($con,$query1);
           while(( $result1 =mysqli_fetch_array($display))&&($result2 =mysqli_fetch_array($display1)) ){?>
                ...
                <div class="row " style="height:15rem">
                    <div class="col-sm-4  ">
                        ...
                        <ul style="list-style-type:circle;">GENERAL INFORMATION
                            ...
                            <li>PLACE_SEEN:<?php echo $result2['place_found'];?></li>
                            <li>DATE_SEEN:<?php echo $result2['date_seen'];?></li>
                        </ul>
                    </div>
                      <?php 
